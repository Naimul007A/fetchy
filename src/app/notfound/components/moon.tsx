...
const Moon = () => {
  return (
    <div
      className="sm:w-40 sm:h-40 w-[100px] h-[100px] relative rounded-full z-[2] bg-white shadow-glow
    ...
    >
      <div className="top-[60%] left-[47%] absolute scale-[0.7] sm:scale-100">
        <div
          ...
          className="rounded-tl-full rounded-br-full rounded-tr-full bg-[#5c3191] w-[25px] h-[25px] absolute animate-snore"
        ></div>
